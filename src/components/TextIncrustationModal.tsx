            ...
            <div className="relative flex items-center space-x-1.5" ref={signaturesMenuRef}>
              ...
              {onOpenKaboStore && (
                <button
                  ...
                  className={`py-1.5 px-2.5 rounded-xl border text-xs font-bold transition flex items-center space-x-1.5 cursor-pointer shadow-xs ${
                    isLight
                      ? "bg-amber-500/10 hover:bg-amber-500/20 text-amber-800 border-amber-300"
                      : "bg-amber-500/15 hover:bg-amber-500/25 text-amber-300 border-amber-500/30"
                  }`}
                  title="Ouvrir la bibliothèque partagée KABO Store pour importer ou partager des signatures"
                >
              ...
              {isSignaturesMenuOpen && (
                ...
                >
                  ...
                  {savedSignatures.length === 0 ? (
                    ...
                    <div className="overflow-y-auto max-h-56 space-y-1.5 pr-1 no-scrollbar">
                  ...
                  {/* Popover Footer: Open KABO Store */}
                  {onOpenKaboStore && (
                    <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
                      <button
                        ...
                        className="w-full py-1.5 px-3 rounded-xl bg-amber-500/15 hover:bg-amber-500/25 text-amber-600 dark:text-amber-300 font-bold text-xs flex items-center justify-center space-x-1.5 border border-amber-500/30 transition cursor-pointer"
                      >
                        <Store className="w-3.5 h-3.5 text-amber-500" />
                        <span>Explorer ou Partager sur KABO Store</span>
                      </button>
                    </div>
                  )}
                </div>
